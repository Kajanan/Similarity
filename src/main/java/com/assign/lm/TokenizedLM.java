...
import com.assign.stats.BinomialDistribution;
...
public class TokenizedLM
    ...
    public double tokenLog2Probability(String[] tokens, int start, int end) {
        ...
        for (int i = start; i < end; ++i) {
            ...
            if (Double.isInfinite(conditionalLog2TokenEstimate)) {
                ...
                log2Estimate
                    +=  com.assign.util.Math.log2(extCountD
    ...
    private double conditionalLog2TokenEstimate(int[] tokIds,
        ...
        return com.assign.util.Math.log2(estimate);
    }
    ...
    static class Externalizer extends AbstractExternalizable {
        ...
        public void writeExternal(ObjectOutput objOut) throws IOException {
            ...
            objOut.writeFloat((float)
                              ...
                              .log2(1.0-mLM.lambda(com.assign.util.Arrays
                                                   .EMPTY_INT_ARRAY)));
            ...
            int[] outcomes
                ...
                .integersFollowing(com.assign.util.Arrays.EMPTY_INT_ARRAY,0,0);
            ...
            for (int i = 1; !queue.isEmpty(); ++i) {
                ...
                if (i <= lastInternalNodeIndex) {
                    objOut.writeFloat((float)
                                      com.assign.util.Math.log2(1.0-mLM.lambda(is)));
