...
import com.assign.io.BitInput;
import com.assign.io.BitOutput;
...
public class TrieCharSeqCounter implements CharSeqCounter {
    ...
    public char[] observedCharacters() {
        return com.assign.util.Arrays.copy(mRootNode.outcomes(new char[] { },0,0));
    }

    public char[] charactersFollowing(char[] cs, int start, int end) {
        Strings.checkArgsStartEnd(cs,start,end);
        return com.assign.util.Arrays.copy(mRootNode.outcomes(cs,start,end));
    }
    ...
    public long count(CharSequence cSeq) {
        return count(com.assign.util.Arrays.toArray(cSeq),0,cSeq.length());
    }
    ...
    public long extensionCount(CharSequence cSeq) {
        return mRootNode.contextCount(com.assign.util.Arrays.toArray(cSeq),0,cSeq.length());
    }
    ...
    public void incrementSubstrings(CharSequence cSeq, int count) {
        incrementSubstrings(com.assign.util.Arrays.toArray(cSeq),
                            0,cSeq.length(),count);
    }
