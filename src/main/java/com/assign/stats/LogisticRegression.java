 ...
 * +1 (718) 290-9170.
 */
package com.assign.stats;

import com.assign.corpus.ObjectHandler;

import com.assign.io.LogLevel;
import com.assign.io.Reporter;
import com.assign.io.Reporters;

import com.assign.matrix.DenseVector;
import com.assign.matrix.Matrices;
...
public class LogisticRegression
     ...
     * reporter.  The prior block size defaults to the number of
     * examples divided by 50.
     *
    ...
    public static LogisticRegression
        ...
        int priorBlockSize = Math.max(1,cs.length / 50);
     ...
     * @param cs Output categories indexed by training case.
     * @param prior The prior to be used for regression.
     * @param priorBlockSize Number of examples whose gradient is
     * updated before the prior gradient is updated.
    ...
    public static LogisticRegression
        ...
        int numOutcomesMinus1 = com.assign.util.Math.max(cs);
        ...
        for (int epoch = 0; epoch < maxEpochs; ++epoch) {
            ...
            for (int j = 0; j < numTrainingInstances; ++j) {
                ...
                if (hasPrior && (j > 0) && ((j % priorBlockSize) == 0)) {
                    adjustWeightsWithPrior(weightVectors,prior,(learningRate * priorBlockSize) / numTrainingInstances);
                }
    ...
    public static double log2Likelihood(Vector[] inputs, int[] cats, LogisticRegression regression) {
        ...
        for (int j = 0; j < numTrainingInstances; ++j) {
            ...
            log2Likelihood += com.assign.util.Math.log2(conditionalProbs[cats[j]]);
        }
