...
public class Statistics {
    ...
    public static double klDivergenceDirichlet(double[] xs, double[] ys) {
        ...
        double divergence
            = (logGamma(sumXs)
               - logGamma(sumYs));
        double digammaSumXs = com.assign.util.Math.digamma(sumXs);
        for (int i = 0; i < xs.length; ++i) {
            divergence +=
                (logGamma(ys[i])
                 - logGamma(xs[i]))
                + (xs[i] - ys[i]) * (com.assign.util.Math.digamma(xs[i]) - digammaSumXs);
        }
        return divergence;
    }
    ...
    static double logGamma(double x) {
        return com.assign.util.Math.log2Gamma(x)
            / com.assign.util.Math.log2(java.lang.Math.E);
    }
    ...
    public static double klDivergence(double[] p, double[] q) {
        ...
        for (int i = 0; i < len; ++i) {
            if (p[i] > 0.0 && p[i] != q[i])
                divergence += p[i] * com.assign.util.Math.log2(p[i] / q[i]);
        }
        return divergence;
    }
    ...
    public static double[] normalize(double[] probabilityRatios) {
        ...
        double sum = com.assign.util.Math.sum(probabilityRatios);
        if (sum <= 0.0) {
    ...
    public static double mean(double[] xs) {
        return com.assign.util.Math.sum(xs) / (double) xs.length;
    }
    ...
    public static double dirichletLog2Prob(double alpha, double[] xs) {
        ...
        int k = xs.length;
        // normalizing term
        double result = com.assign.util.Math.log2Gamma(k * alpha)
            - k * com.assign.util.Math.log2Gamma(alpha);
        double alphaMinus1 = alpha - 1;
        for (int i = 0; i < k; ++i)
            result += alphaMinus1 * com.assign.util.Math.log2(xs[i]);
        return result;
    }
    ...
    public static double dirichletLog2Prob(double[] alphas, double[] xs) {
        ...
        for (int i = 0; i < alphas.length; ++i) {
            alphaSum += alphas[i];
            result -= com.assign.util.Math.log2Gamma(alphas[i]);
        }
        result += com.assign.util.Math.log2Gamma(alphaSum);
        for (int i = 0; i < k; ++i)
            result += (alphas[i] - 1) * com.assign.util.Math.log2(xs[i]);
        return result;
    }
