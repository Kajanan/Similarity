...
public class TfIdfClassifierTrainer<E>
    ...
    /**
     * Return a copy of the set of categories for which at least one
     * training instance has been seen.  
     *
    ...
    static class TfIdfClassifier<G>
        ...
        public ScoredClassification classify(G in) {
            ...
            for (int i = 0; i < categoryScores.length; ++i) {
                ...
                categoryScores[i] = new ScoredObject<String>(mCategories[i],score);
            }
