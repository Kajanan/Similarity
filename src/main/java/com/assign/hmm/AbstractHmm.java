...
public abstract class AbstractHmm implements HiddenMarkovModel {
	...
	return com.assign.util.Math.log2(startProb(state));
    }
	...
	return com.assign.util.Math.log2(startProb(stateId));
    }
	...
	return com.assign.util.Math.log2(endProb(state));
    }
	...
	return com.assign.util.Math.log2(endProb(stateId));
    }
	...
	return com.assign.util.Math.log2(transitProb(source,target));
    }
	...
	return com.assign.util.Math.log2(transitProb(sourceId,targetId));
    }
	...
	return com.assign.util.Math.log2(emitProb(stateId,emission));
    }
	...
	return com.assign.util.Math.log2(emitProb(state,emission));
    }
